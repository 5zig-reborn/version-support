...
public class WrappedItemStack implements ItemStack {
	...
	public List<String> getLore() {
		return item.getTooltip(((Variables) MinecraftFactory.getVars()).getPlayer(), ITooltipFlag.TooltipFlags.NORMAL);
	}
	...
	public static String getResourceKey(net.minecraft.item.ItemStack item) {
		net.minecraft.util.ResourceLocation resourceLocation = Item.REGISTRY.getNameForObject(item.getItem());
