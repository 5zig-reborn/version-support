...
public class Variables implements IVariables, GLFWKeyCallbackI {
	...
	public Variables() {
		...
		Mouse.init(new Mouse.MouseHandler() {
			...
			@Override
			public int getY() {
				return (int) (getMinecraft().func_228018_at_().getHeight() - getMinecraft().mouseHelper.getMouseY());
			}
		});
		...
		previousCallback = GLFW.glfwSetKeyCallback(getMinecraft().func_228018_at_().getHandle(), this);
	...
	public double getPlayerPosX() {
		return getSpectatingEntity().lastTickPosX;
	}

	@Override
	public double getPlayerPosY() {
		return getSpectatingEntity().lastTickPosY;
	}

	@Override
	public double getPlayerPosZ() {
		return getSpectatingEntity().lastTickPosZ;
	}
	...
	public String getBiome() {
		...
		return localObject.func_225549_i_().func_225526_b_((int) getPlayerPosX(), (int) getPlayerPosY(), (int) getPlayerPosZ())
	...
	public int getLightLevel() {
		...
		BlockPos localdt = new BlockPos(getPlayerPosX(), getPlayerPosY(), getPlayerPosZ());
		return getWorld().getNeighborAwareLightSubtracted(localdt, 0);
	}
	...
	public void updateScaledResolution() {
		this.scaledResolution = getMinecraft().func_228018_at_();
	}
	...
	public void bindTexture(Object resourceLocation) {
		if (resourceLocation instanceof DynamicTexture) {
			GlStateManager.func_227760_t_(((DynamicTexture)resourceLocation).getGlTextureId());
		} else {
	...
	public Object createDynamicImage(Object resourceLocation, int width, int height) {
		...
		getTextureManager().func_229263_a_((net.minecraft.util.ResourceLocation) resourceLocation, dynamicImage);
		return dynamicImage;
	}

	@Override
	public Object getTexture(Object resourceLocation) {
		return getTextureManager().func_229267_b_((net.minecraft.util.ResourceLocation) resourceLocation);
	}
