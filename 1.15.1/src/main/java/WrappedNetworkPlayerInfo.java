...
public class WrappedNetworkPlayerInfo implements NetworkPlayerInfo {
	...
	private net.minecraft.client.network.play.NetworkPlayerInfo wrapped;

	public WrappedNetworkPlayerInfo(net.minecraft.client.network.play.NetworkPlayerInfo wrapped) {
