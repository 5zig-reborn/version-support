...
public class FileSelector implements IFileSelector {
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
		...
		worldRenderer.func_225582_a_((double) left, (double) bottom, 0.0D).func_225583_a_(((float) left / var7), ((float) (bottom + (int) amountScrolled) / var7))
				.func_225586_a_(32, 32, 32, 255).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) bottom, 0.0D).func_225583_a_(((float) right / var7), ((float) (bottom + (int) amountScrolled) / var7))
				.func_225586_a_(32, 32, 32, 255).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) top, 0.0D).func_225583_a_(((float) right / var7), ((float) (top + (int) amountScrolled) / var7))
				.func_225586_a_(32, 32, 32, 255).endVertex();
		worldRenderer.func_225582_a_((double) left, (double) top, 0.0D).func_225583_a_(((float) left / var7), ((float) (top + (int) amountScrolled) / var7))
				.func_225586_a_(32, 32, 32, 255).endVertex();
		tessellator.draw();
		...
		// Schatten
		worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		worldRenderer.func_225582_a_((double) left, (double) (top + var10), 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(0, 0, 0, 0).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) (top + var10), 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(0, 0, 0, 0).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) top, 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
		worldRenderer.func_225582_a_((double) left, (double) top, 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
		tessellator.draw();
		worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		worldRenderer.func_225582_a_((double) left, (double) bottom, 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) bottom, 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
		worldRenderer.func_225582_a_((double) right, (double) (bottom - var10), 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(0, 0, 0, 0).endVertex();
		worldRenderer.func_225582_a_((double) left, (double) (bottom - var10), 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(0, 0, 0, 0).endVertex();
		tessellator.draw();
		int var11 = m();
		if (var11 > 0) {
			...
			worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			worldRenderer.func_225582_a_((double) scrollX0, (double) bottom, 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX1, (double) bottom, 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX1, (double) top, 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX0, (double) top, 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
			tessellator.draw();
			worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			worldRenderer.func_225582_a_((double) scrollX0, (double) (var13 + var12), 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(128, 128, 128, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX1, (double) (var13 + var12), 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(128, 128, 128, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX1, (double) var13, 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(128, 128, 128, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX0, (double) var13, 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(128, 128, 128, 255).endVertex();
			tessellator.draw();
			worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			worldRenderer.func_225582_a_((double) scrollX0, (double) (var13 + var12 - 1), 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(192, 192, 192, 255).endVertex();
			worldRenderer.func_225582_a_((double) (scrollX1 - 1), (double) (var13 + var12 - 1), 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(192, 192, 192, 255).endVertex();
			worldRenderer.func_225582_a_((double) (scrollX1 - 1), (double) var13, 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(192, 192, 192, 255).endVertex();
			worldRenderer.func_225582_a_((double) scrollX0, (double) var13, 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(192, 192, 192, 255).endVertex();
			tessellator.draw();
		}
		...
		for (int i = 0; i < rows; ++i) {
			...
			for (int j = 0; j < columnCount; j++) {
				...
				if (isSelected(id)) { // callIsSelected
					...
					GlStateManager.func_227621_I_();
					worldRenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
					worldRenderer.func_225582_a_((double) nx, (double) (ny + padding + 2), 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(128, 128, 128, 255).endVertex();
					worldRenderer.func_225582_a_((double) nx1, (double) (ny + padding + 2), 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(128, 128, 128, 255).endVertex();
					worldRenderer.func_225582_a_((double) nx1, (double) (ny - 2), 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(128, 128, 128, 255).endVertex();
					worldRenderer.func_225582_a_((double) nx, (double) (ny - 2), 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(128, 128, 128, 255).endVertex();
					worldRenderer.func_225582_a_((double) (nx + 1), (double) (ny + padding + 1), 0.0D).func_225583_a_(0.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
					worldRenderer.func_225582_a_((double) (nx1 - 1), (double) (ny + padding + 1), 0.0D).func_225583_a_(1.0f, 1.0f).func_225586_a_(0, 0, 0, 255).endVertex();
					worldRenderer.func_225582_a_((double) (nx1 - 1), (double) (ny - 1), 0.0D).func_225583_a_(1.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
					worldRenderer.func_225582_a_((double) (nx + 1), (double) (ny - 1), 0.0D).func_225583_a_(0.0f, 0.0f).func_225586_a_(0, 0, 0, 255).endVertex();
					tessellator.draw();
					GlStateManager.func_227619_H_();
				}
	...
	protected void overlayBackground(int var, int var1, int var2, int var3) {
		...
		var5.func_225582_a_((double) left, (double) var1, 0.0D).func_225583_a_(0.0f, ((float) var1 / 32.0F)).func_225586_a_(64, 64, 64, var3).endVertex();
		var5.func_225582_a_((double) (left + (right - left)), (double) var1, 0.0D).func_225583_a_(((float) (right - left) / 32.0F), ((float) var1 / 32.0F)).func_225586_a_(64, 64, 64, var3).endVertex();
