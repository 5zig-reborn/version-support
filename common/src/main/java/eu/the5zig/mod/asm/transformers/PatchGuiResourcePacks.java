    ...
    public class PatchInitGui extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == RETURN) {
                ...
                mv.visitVarInsn(ALOAD, 0);
                mv.visitVarInsn(ALOAD, 0);
                mv.visitFieldInsn(GETFIELD, Names.guiResourcePacks.getName(), "g", "Ljava/util/List;");
                mv.visitVarInsn(ALOAD, 0);
                mv.visitFieldInsn(GETFIELD, Names.guiResourcePacks.getName(), "h", "Ljava/util/List;");
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiResourcePacksInit", "(Ljava/lang/Object;Ljava/util/List;Ljava/util/List;)V", false);
            }
    ...
    public class PatchMouseClicked extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == RETURN) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiResourcePacksMouseClicked", "(III)V", false);
            }
            super.visitInsn(opcode);
        }
